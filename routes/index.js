...
router.post('/token', function (req, res, next) {
    ...
    var rt = req.body["requestheader"]["clientidentifier"];
    if (rt.length > 0) {

        res.set('Content-Type', 'text/xml');
        var token = makeid();
        var respStr = "<?xml version='1.0' encoding='utf-16'?><GetToken><TransactionID></TransactionID><RequestType>000</RequestType><ResponseCode>00000</ResponseCode><responseMessage><Token>" + token + "</Token></responseMessage></GetToken>";
        res.send(respStr);
    } else {
